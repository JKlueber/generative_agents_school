...
\toprule
{\normalsize\bfseries Party} & {\normalsize\bfseries Key Programme Points} \\
\midrule
\endfirsthead
...
\begin{itemize}[leftmargin=*, nosep]
  ...
  \item \textbf{All-day \& After-school:} Expansion of all-day offers; abolition of after-school care (\emph{Hort}\footnote{\textbf{Hort:} After-school care programme located at primary schools.}) fees (gradual expansion to grades 5--6); full-time contracts for educators.
...
CDU & 
\begin{itemize}[leftmargin=*, nosep]
  \item \textbf{School Type:} Retention of tracked school system; state-wide retention of special schools (\emph{Förderschulen}\footnote{\textbf{Förderschule:} Specialised school for children with physical, mental, or learning disabilities.}).
...
\begin{itemize}[leftmargin=*, nosep]
  ...
  \item \textbf{Graduation \& Retention:} Abolishing \emph{BLF} (automatic certificate on grade 11 promotion); abolishing grade retention in favour of targeted support.
\end{itemize} \\ \hline \noalign{\vskip 0.5ex}

CDU & 
\begin{itemize}[leftmargin=*, nosep]
  \item \textbf{Grading \& Retention:} Reintroduction of conduct grades (\emph{Kopfnoten}\footnote{\textbf{Kopfnoten:} Conduct grades assessing behaviour, effort, participation, orderliness.}: behaviour, effort, participation, orderliness); binding promotion decisions starting grade 2.
...
% ==================== CATEGORY 4 ====================
\multicolumn{2}{c}{\normalsize\bfseries 4. Digitalisation \& Media} \\* [0.5ex] 
\hline \noalign{\vskip 0.8ex}
...
AfD & 
\begin{itemize}[leftmargin=*, nosep]
  \item \textbf{Stance:} ``Digitalisation with a sense of proportion''; rejecting replacement of teachers by digital media.
...
\begin{itemize}[leftmargin=*, nosep]
  ...
  \item \textbf{Language Support:} Overall concept for non-native German speakers focusing on German as Second Language (\emph{DaZ}\footnote{\textbf{DaZ:} German as a Second Language instruction programmes.}) teachers.
\end{itemize} \\ \hline \noalign{\vskip 0.5ex}
